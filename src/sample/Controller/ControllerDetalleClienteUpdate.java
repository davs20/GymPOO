...
public class ControllerDetalleClienteUpdate implements Initializable {
    ...
    public void setCliente(String id) {
        ...
        try {
            ...
            apellidotxt.setText(datosCliente.getString("apellido"));
            alturatxt.setText("" + datosCliente.getDouble("altura"));
            pesotxt.setText(""+datosCliente.getDouble("peso"));
            fuerzatxt.setText(""+datosCliente.getDouble("fuerza"));
            edadtxt.setText(""+datosCliente.getInt("edad"));
            padecimiento.getSelectionModel().select(1);
            fecha.setValue(datosCliente.getDate("fechaNacimiento").toLocalDate());
            datosCliente.close();
    ...
    public void datosMedicos(ActionEvent actionEvent) {
        ...
        if (idbol && nombres && telefono && edad && apellidos && correo) {
    ...
    public void initialize(URL arg0, ResourceBundle arg1) {
        ...
        cbCameraOptions.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<ControllerDetalleClienteUpdate.WebCamInfo>() {

            @Override
            public void changed(ObservableValue<? extends WebCamInfo> arg0, ControllerDetalleClienteUpdate.WebCamInfo arg1, ControllerDetalleClienteUpdate.WebCamInfo arg2) {
                if (arg2 != null) {
